    ...
    <section className="container mb-12 bg-gray-100 p-5">
      ...
      <div className="relative">
        ...
        <button
          ...
          className="absolute top-1/4 -left-6 h-20 w-8 bg-white shadow-2xl flex justify-center items-center"
        >
          <MdArrowBackIos className="text-black text-xl" />
        </button>
        <button
          onClick={() => homePublisherSlBtns.current.slickNext()}
          className="absolute top-1/4 -right-6 h-20 w-8 bg-white shadow-2xl flex justify-center items-center"
        >
